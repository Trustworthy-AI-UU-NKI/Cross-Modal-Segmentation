...
## Code structure
- The `checkpoints` folder contains all checkpoints from the UNet-NA, UNet-FS and the second stage (after DRIT) UNet and ResUNet models. To load the checkpoints in this folder, please load them from [Huggingface]().
